 ...
 *
 * edited by Becky Gilbert to hide back/previous button on first page
 * *
 */

jsPsych.plugins["instructions-hide-first-back"] = (function() {

  var plugin = {};

  plugin.info = {
    name: 'instructions-hide-first-back',
    description: '',
    parameters: {
      pages: {
